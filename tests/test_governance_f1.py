...
class InheritedGovernanceRetentionTests(unittest.TestCase):
    ...
    def test_architecture_binds_accepted_f7_parent_and_retains_early_authorities(self) -> None:
        a = self.architecture
    ...
    def test_architecture_retains_f2_through_f8_schema_locks(self) -> None:
        for milestone in ("f2", "f3", "f4", "f5", "f6", "f7", "f8"):
    ...
    def test_architecture_lock_matches_canonical_f8_manifest(self) -> None:
        ...
        self.assertEqual(lock["architecture_id"], f"AMEV-F8-ARCH-v1-{digest[:12]}")
