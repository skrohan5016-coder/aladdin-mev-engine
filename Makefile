.PHONY: compile test policy architecture source-contracts f2-schemas f3-schemas all
PYTHON ?= python3
...
all: compile test policy architecture source-contracts f2-schemas f3-schemas
