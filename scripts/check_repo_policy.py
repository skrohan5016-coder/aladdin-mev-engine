...
REQUIRED_COMPONENTS = {
    ...
    "separate-all-attempt-and-scoreable-inclusion-block-diversity-metrics",
    "unique-scoreable-inclusion-block-diversity-promotion-gate",
...
REQUIRED_INVARIANTS = {
    ...
    "research-promotion-requires-minimum-scoreable-coverage-and-unique-scoreable-inclusion-block-diversity",
    "unscoreable-inclusion-blocks-cannot-satisfy-scoreable-sample-diversity-promotion-gates",
